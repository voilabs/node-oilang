...
const ElysiaApp = new Elysia({ name: "oilang" })
    ...
    .group("/oilang", (app) => {
        ...
        app.group("/locales", (localesApp) => {
            ...
            localesApp.put("/:localeCode", async ({ body, params }) => {}, {
                body: t.Object({
                    native_name: t.String(),
                    english_name: t.String(),
                }),
            ...
            localesApp.delete("/:locale", async ({ params }) => {}, {
                params: t.Object({
                    locale: t.String(),
                }),
            });
            ...
            app.group("/translations", (translationsApp) => {
                ...
                translationsApp.delete(
                    ...
                    async ({ params, request, body }) => {
                        const { translations } = body;
                        for (const t of translations) {
                            await oilang.translations.delete(
                                params.locale,
                                t.key,
                            );
                        }
